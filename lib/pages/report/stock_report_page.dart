...
import 'package:point_of_sales/pages/report/stock_report_detail_page.dart';
              ...
              child: Theme(
                ...
                child: Scrollbar(
                  ...
                  child: ListView.builder(
                      itemCount: stockController.stockHistory.length,
                      itemBuilder: (context, index) {
                        final history = stockController.stockHistory[index];

                        Product? product =
                            productController.getProductById(history.productId);
                                      ...
                                      Row(
                                        children: <Widget>[
                                          ...
                                          Container(
                                            ...
                                            child: Center(
                                              child: Text(
                                                "${history.type} ${history.quantity} stok",
                                                style: GoogleFonts.poppins(
                                                    color: Colors.white,
                                                    fontWeight: FontWeight.w400,
                                                    fontSize: 12),
